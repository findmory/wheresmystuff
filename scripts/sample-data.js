...
module.exports = {  
  item1 : {
    ...
    desc : 'Everyones favorite white item. We will cut it to the size you need and ship it.',
    location : 'box1',
    status : 'available'
  },
  ...
  item6 : {
    ...
    image : 'http://i.istockimg.com/file_thumbview_approve/56241842/5/stock-photo-56241842-salmon-item.jpg',
